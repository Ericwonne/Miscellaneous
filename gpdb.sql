...
INSERT INTO `course_information` VALUES ('CAXX000001','马克思主义概论','UT00000001','2018-02-02','2018-03-20','2018-06-20','综合教学楼（704）','星期一上午一二节',NULL,NULL,NULL,NULL,NULL,''),('CAXX000002','毛泽东思想与社会主义概论',NULL,NULL,NULL,NULL,NULL,NULL,'EAXX000004',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `exam_information` (
  ...
  `examDuration` enum('0.5','1','1.5','2','2.5','3','3.5','4') DEFAULT '1' COMMENT '格式为二位数字型字符串，例如25，则表示考试时长为2.5小时，10为1小时，05为0.5小时',
  `examVenue` char(2) DEFAULT NULL COMMENT '格式：同上课地点（venue）',
  `examType` enum('开卷','闭卷') DEFAULT '闭卷' COMMENT '格式：开卷/闭卷',
  PRIMARY KEY (`examID`),
  ...
  CONSTRAINT `examVenue` FOREIGN KEY (`examVenue`) REFERENCES `room_information` (`roomID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `exam_information` VALUES ('EAXX000001','CAXX000001','2018-10-15 15:00:00','2.5',NULL,'开卷'),('EAXX000002',NULL,NULL,'1',NULL,'闭卷'),('EAXX000003',NULL,NULL,'2',NULL,'闭卷'),('EAXX000004',NULL,NULL,'1',NULL,'闭卷');
...
INSERT INTO `student_information` VALUES ('US00000001','王启帆','M',22,'wangqifan1996@126.com','EricWong1996','1318272348','15316831783','上海理工大学','光电信息与计算机工程学院','计算机科学与技术','B','SE','1318272348',NULL);
...
INSERT INTO `subject_category` VALUES ('CA','哲学'),('CB','经济学'),('CC','法学'),('CD','教育学'),('CE','文学'),('CF','历史学'),('CG','理学'),('CH','工学'),('CI','农学'),('CJ','医学'),('CK','军事学'),('CL','管理学'),('CM','艺术学'),('CN','【测试数据】'),('CO','【测试数据】'),('CP','【测试数据】');
...
INSERT INTO `teacher_information` VALUES ('UT00000001','庙军培','M',23,'miaojunpei1995@qq.com',NULL,NULL,NULL,'北京邮电大学',NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2018-03-24 18:57:32
